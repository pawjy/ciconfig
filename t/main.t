  ...
  [{circleci => {'docker-build' => 'abc/def'}} => {'.circleci/config.yml' => {json => {
    ...
    jobs => {build => {
      ...
      steps => [
        ...
        {run => {command => 'docker build --cache-from abc/def -t abc/def .'}},
        {store_artifacts => {path => '/tmp/circle-artifacts/build'}},
  ...
  [{circleci => {'docker-build' => 'xyz/abc/def'}} => {'.circleci/config.yml' => {json => {
    ...
    jobs => {build => {
      ...
      steps => [
        ...
        {run => {command => 'mkdir -p $CIRCLE_ARTIFACTS'}},
        {run => {command => 'docker info'}},
        {run => {command => 'docker build --cache-from xyz/abc/def -t xyz/abc/def .'}},
        {store_artifacts => {path => '/tmp/circle-artifacts/build'}},
  ...
  [{circleci => {
    ...
    jobs => {build => {
      ...
      steps => [
        ...
        {run => {command => 'mkdir -p $CIRCLE_ARTIFACTS'}},
        {run => {command => 'docker info'}},
        {run => {command => 'docker build --cache-from xyz/$ABC/def:$CIRCLE_SHA1 -t xyz/$ABC/def:$CIRCLE_SHA1 .'}},
        {store_artifacts => {path => '/tmp/circle-artifacts/build'}},
  ...
  [{github => {
    ...
    jobs => {test => {
      ...
      steps => [
        ...
        {run => 'mkdir -p $CIRCLE_ARTIFACTS'},
        {run => 'docker build --cache-from foo\\.test\\/bar\\/z123 -t foo\\.test\\/bar\\/z123 \\.'},
        {run => 'x'},
        {uses => 'actions/upload-artifact@v4',
         with => {path => '/tmp/circle-artifacts/test'},
         if => '${{ always () }}'},
  ...
  [{github => {
    ...
    jobs => {test => {
      ...
      steps => [
        ...
        {run => 'mkdir -p $CIRCLE_ARTIFACTS'},
        {run => 'docker build --cache-from foo\\.test\\/bar\\/z123 -t foo\\.test\\/bar\\/z123 foo\\/bar'},
        {run => 'x'},
        {uses => 'actions/upload-artifact@v4',
         with => {path => '/tmp/circle-artifacts/test'},
         if => '${{ always () }}'},
  ...
  [{github => {
    ...
    jobs => {test => {
      ...
      steps => [
        ...
        {run => 'mkdir -p $CIRCLE_ARTIFACTS'},
        {run => 'fo/o b\\ar --cache-from foo\\.test\\/bar\\/z123 -t foo\\.test\\/bar\\/z123 \\.'},
        {run => 'x'},
        {uses => 'actions/upload-artifact@v4',
         with => {path => '/tmp/circle-artifacts/test'},
         if => '${{ always () }}'},
  ...
  [{github => {
    ...
    jobs => {test => {
      ...
      steps => [
        ...
        {run => 'mkdir -p $CIRCLE_ARTIFACTS'},
        {run => 'docker build --cache-from foo\\.test\\/bar\\/z123 -t foo\\.test\\/bar\\/z123 \\.', env => {
          "a/b" => '${{ secrets.a/b }}',
          "b\\c" => '${{ secrets.b\\c }}',
        }},
        {run => 'x'},
