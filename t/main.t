  ...
  [{droneci => {
    ...
    steps => [{
      ...
      commands => [
        ...
        'timeout 3 bash -c a\\\\b &',
        'bash -c cd\\ c\\\\\\\\d\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'bash -c cd\\ \\`cat\\ \\/drone\\/src\\/local\\/ciconfig\\/dockershareddir\\`\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'bash -c cd\\ \\`cat\\ \\/drone\\/src\\/local\\/ciconfig\\/dockershareddir\\`\\ \\&\\&\\ cd\\ c\\\\\\\\d\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'docker exec -t `cat /drone/src/local/ciconfig/dockername` bash -c timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'docker exec -t `cat /drone/src/local/ciconfig/dockername` bash -c cd\\ c\\\\\\\\d\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'docker exec -t `cat /drone/src/local/ciconfig/dockername` bash -c cd\ `cat /drone/src/local/ciconfig/dockershareddir`\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'docker exec -t `cat /drone/src/local/ciconfig/dockername` bash -c cd\ `cat /drone/src/local/ciconfig/dockershareddir`\\ \\&\\&\\ cd\\ c\\\\\\\\d\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'docker exec -t -e AB=$AB -e X\\Y=$X\\Y `cat /drone/src/local/ciconfig/dockername` bash -c cd\ `cat /drone/src/local/ciconfig/dockershareddir`\\ \\&\\&\\ cd\\ c\\\\\\\\d\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b',
        'docker exec -t -e AB=$AB -e X\\Y=$X\\Y `cat /drone/src/local/ciconfig/dockername` bash -c cd\ `cat /drone/src/local/ciconfig/dockershareddir`\\ \\&\\&\\ cd\\ c\\\\\\\\d\\ \\&\\&\\ timeout\\ 3\\ bash\\ \\-c\\ a\\\\\\\\b &',
      ],
      depends_on => [qw(build)],
    }, {
